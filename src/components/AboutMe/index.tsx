    ...
    <div className="w-full min-h-section-common bg-primary px-14 py-10 flex flex-col items-center justify-between border-secondary border-l-8">
      ...
      <Section aosData="fade-right">
        ...
        <p className="max-[700px]:text-2xl text-tertiary text-4xl exo-2-regular text-justify w-6/12 max-[800px]:w-8/12 max-[400px]:w-11/12 min-w-48">
          ...
          que já havia construído tinham mais cara de TCC, ainda si acreditei na ideia junto dos meus
          orientadores e integrantes do grupo, então intensifiquei os meus
          estudos a respeito dos temas do trabalho e das{" "}
          <a
            target="_blank"
            rel="noreferrer"
            className="text-secondary font-normal underline"
